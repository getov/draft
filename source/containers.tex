...
\tcode{a.erase(q1, q2)}
&   \tcode{iterator}
&   Erases all elements in the range \tcode{[q1, q2)}. Returns an iterator
    pointing to the element pointed to by \tcode{q2} prior to any elements
    being erased. If no such element exists, \tcode{a.end()} is returned.%
    \indextext{unordered associative containers!\idxcode{erase}}%
    \indextext{\idxcode{erase}!unordered associative containers}%
